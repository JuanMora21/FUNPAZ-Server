...
export default class extends BaseSeeder {
  public async run () {
    await Permiso.createMany([
      ...
      { url: '/EpsInfo', metodo: 'GET' },
      { url: '/EpsInfo', metodo: 'POST' },
      { url: '/EpsInfo/:id', metodo: 'GET' },
      { url: '/EpsInfo/:id', metodo: 'PUT' },
      { url: '/EpsInfo/:id', metodo: 'DELETE' },
    ])
    ...
    await RolPermiso.createMany([
      ...
      { id_rol: 1, id_permiso: 106 },
      { id_rol: 1, id_permiso: 107 },
      { id_rol: 1, id_permiso: 108 },
      { id_rol: 1, id_permiso: 109 },
      { id_rol: 1, id_permiso: 110 },

      // Permisos gestor de contenidos
      ...
      { id_rol: 4, id_permiso: 106 },
      { id_rol: 4, id_permiso: 107 },
      { id_rol: 4, id_permiso: 108 },
      { id_rol: 4, id_permiso: 109 },
